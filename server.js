...
// to parse the body of request from client
app.use(bodyParser.urlencoded({extended:false}));
app.use(bodyParser.json());

app.post('/authentication', function(req,res){
    // response passed along with token
    // token has sign {parameter being passed, secret key, duration}
...
//middleware to verify the token value
